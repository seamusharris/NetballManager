...
import { Bell, Search, ChevronDown, Home, Users, ClipboardList, Calendar, CalendarRange, BarChart, Database, Zap, Settings as SettingsIcon, Trophy, Menu, Building2, Target } from 'lucide-react';
