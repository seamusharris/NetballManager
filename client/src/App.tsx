  ...
  return (
    <Layout>
      <Switch>
        ...
        <Route path="/teams/:teamId/analysis" component={withErrorBoundary(TeamPreparation, 'TeamPreparation')} />
        <Route path="/teams/:teamId/analysis/:opponentId" component={withErrorBoundary(TeamPreparation, 'TeamPreparation')} />
