...
import { Position, POSITIONS, allGameStatuses } from '@shared/schema';
                ...
                <div>
                  <div className="relative w-full" style={{ height: '500px', backgroundColor: '#9dd26f', borderRadius: '0.5rem' }}>
                    ...
                    {POSITIONS.map(position => {
                      ...
                      let y;
                      if (position === 'GS') y = '15%';
                      else if (position === 'GA') y = '30%';
                      else if (position === 'WA') y = '45%';
                      else if (position === 'C') y = '55%';
                      else if (position === 'WD') y = '70%';
                      else if (position === 'GD') y = '85%';
                      else if (position === 'GK') y = '95%';
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            <div className="font-bold text-center text-base md:text-lg" style={{ color: '#fff' }}>{position}</div>
                          </div>
                          {playerName && (
                            <div className="text-xs md:text-sm text-center font-medium leading-tight mx-1 mt-1 bg-white px-1 rounded">
                              {playerName}
                            </div>
                          )}
                          {!playerName && (
                            <div className="text-xs text-red-500 text-center mt-1 bg-white px-1 rounded">Unassigned</div>
                          )}
                        </div>
                      );
                    })}
                        ...
                        return (
                          ...
                          >
                            <div className="mb-2 pb-2 border-b">
                              ...
                              {playerName && <div className="text-sm text-center">{playerName}</div>}
                            </div>
                            
                            {playerName && playerStats && (
                              <div className="bg-gray-50 p-3 rounded-md border border-gray-100">
                                <PositionStatsBox position={position} playerStats={playerStats} />
                              </div>
                            )}
