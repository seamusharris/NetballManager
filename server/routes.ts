...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // REMOVED: Duplicate PATCH /api/players/:id handler - now handled in player-routes.ts
 ...
 // [GAME ENDPOINTS REMOVED] - now in server/game-routes.ts 
  ...
  // [LEGACY INDIVIDUAL STAT ENDPOINTS REMOVED] - use /api/teams/:teamId/games/:gameId/stats/batch instead
